         ...
         body: StreamBuilder<bool>(
           ...
           builder: (context, snapshot) {
             return ModalProgressHUD(
               inAsyncCall: ( snapshot.data == null || !snapshot.data ) ? false : true,
                child: Stack(
                 children: <Widget>[
                      _fondo(),
             ...
             progressIndicator: CircularProgressIndicator(
                    valueColor:  new AlwaysStoppedAnimation<Color>(Colores.COLOR_AZUL_ATC_FARMA),
              ),
            );
           }
         )
      ...
      final tamanoPhone = MediaQuery.of(context).size;
          return Container(
              ...
              child: Column(
                      ...
                      children: <Widget>[
                            Text("Canje de puntos", style: TextStyle( color: Colors.white,  fontSize: 35.0 ) , ),
                            SizedBox(  height: 15, ),
                            Text("Selecione...", style: TextStyle( color: Colors.white,  fontSize: 25.0 ) , ),
                 ...
                 builder: (context, snapshot) {
                   return TextField(
                                  ...
                                  onChanged: ( value ){
                                   ...
                                   onTap: () {
                                      FocusScope.of(contextoSeleccionar).requestFocus(new FocusNode());
                                        this.verificadorInternet.verificarConexion()
                                              .then((onValue){
                                                  if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                                     ...
                                                     this.base.showSnackBar(Constantes.error_conexion, context, Colors.brown);
                                                  }
                                              });
                ...
                builder: ( BuildContext contexto , AsyncSnapshot<Map<String,dynamic>> asyncSnapshot ){
                      ...
                      if( !asyncSnapshot.hasError && asyncSnapshot.hasData ){
                          ...
                          if( respuesta[Constantes.estado] == Constantes.respuesta_estado_ok ){
                               ...
                               List<StoreInfo> listaDeTiendas = respuesta[Constantes.mensaje] as List<StoreInfo>;
                                         ...
                                         return GestureDetector(
                                                  child:  Card(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Center(child: Text(listaDeTiendas[indice].name)),
                                                      ) ,  
                                                  ),
                                                  onTap: (){
                                                        print(listaDeTiendas[indice].name);
                                                        this.controladorTienda.text =  listaDeTiendas[indice].name;
                                                        this.id_tienda_seleccionado = listaDeTiendas[indice].id;  
                                                       provedorDeBloc.addDataToTiendaRedeenTwo( listaDeTiendas[indice].name);
                          ...
                          return Center(
                              child:  this.base.retornarCircularCargando(Colores.COLOR_AZUL_ATC_FARMA),
                          );
                           ...
                           this.verificadorInternet.verificarConexion()
                                    .then((onValue){
                                          if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                                ...
                                                insertRedeenProvider.insertarRedencion(contexto, provedorDeBloc.ultimoValorMontRedeenTwo, this.id_tienda_seleccionado )
                                                      .then((onValue){
                                                          ...
                                                          if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                                                ...
                                                                _dialogSalirPuntosMenos(contexto, onValue[Constantes.mensaje]);
            ...
            children: <Widget>[
                Expanded(
                       ...
                       onPressed:   () {
                                  ...
                                  Navigator.of(contextoFilaBotones).popAndPushNamed(HomePage.nameOfPage);
          ...
          child: Column(
               ...
               children: <Widget>[
                      Padding(
                        ...
                        child: Image(image: AssetImage("assets/imagenes/logo_fridolin.png")),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text( "No volverá a ver su pin de redención. ¿Está seguro que desea salir?", textAlign: TextAlign.center ,style: TextStyle( color: Colors.white, fontSize: 15.0), ),
                      ),
                      Expanded(
...
void _mostrarPin( BuildContext contexto, String pin){
        ...
        child: Container(
          ...
          child: Column(
               ...
               children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only( top: 4.0, bottom: 8.0, left: 8.0, right: 8.0 ),
                        child: Text( "Por favor, dicte este pin: "+pin, textAlign: TextAlign.center ,style: TextStyle( color: Colors.white, fontSize: 15.0 ), ),
                      ),
                      RaisedButton(
                                onPressed:   () {
                                ...
                                child: Container(
                                        child: Text("Salir"),
                                        padding: EdgeInsets.symmetric( horizontal: 75.0, vertical: 0.0) 
                                  ),
 ...
 void _dialogSalirPuntosMenos(BuildContext contextBtnpuntosMenos, String mensajeAMostrar){
        ...
        child: Container(
          ...
          child: Column(
               ...
               children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only( top: 4.0, bottom: 8.0, left: 8.0, right: 8.0 ),
                        child: Text( mensajeAMostrar, textAlign: TextAlign.center ,style: TextStyle( color: Colors.white, ), ),
                      ),
                      Expanded(
                          child: RaisedButton(
                       onPressed:   () {
                                     provedorDeBloc.addDataToTiendaRedeenTwo("");
                                     provedorDeBloc.addDataToMontoRedeenTwo("0");
                                     Navigator.of(contextBtnpuntosMenos).popAndPushNamed(HomePage.nameOfPage);
                               } ,  
