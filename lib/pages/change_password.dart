...
import 'package:bago/providers/change_passwordProvider.dart';
    ...
    this.verificadorInternet  = VerificadorInternet();  
                      ...
                      child: Column(
                        children: <Widget>[
                           ...
                           Container(
                              ...
                              child:Image(image: AssetImage("assets/imagenes/logo_fridolin.png") , fit: BoxFit.cover,),
                           ),
                                               ...
                                               this.verificadorInternet.verificarConexion()
                                                .then((onValue){
                                                      if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                                          ...
                                                          Map<String,String> parametros = _obtenerParametros(contextoCambiar);
                                                          changePassProvider.changePass(parametros, contextoCambiar)
                                                                .then((onValue){
                                                                      provedorBlocLoyalty.addDataToLoadingChangePass(false);
                                                                      if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok){
                                                                                this.base.showSnackBar(onValue[Constantes.mensaje], contextoCambiar, Colores.COLOR_AZUL_ATC_FARMA);
                                                                      } else {
                                                                          this.base.showSnackBar("Hubo un problema vuelva a intentarlo", contextoCambiar, Colores.COLOR_AZUL_ATC_FARMA);
                                                                      }    
                                                                });
                                                      }else {
                                                        this.base.showSnackBar(Constantes.error_conexion, contextoCambiar, Colores.COLOR_AZUL_ATC_FARMA);
                                                      }
                                                });     

                                          }else{
                                              this.base.showSnackBar("Las contraseñas no coinciden", contextoCambiar, Colores.COLOR_AZUL_ATC_FARMA);
                                          }

                                            

                                      } else {
                                          this.base.showSnackBar("Llenar correctamente los campos", contextoCambiar, Colores.COLOR_AZUL_ATC_FARMA);
                                      }
                              },  
     ...
     Map<String, String> _obtenerParametros( BuildContext contextoObtPara ){
          ...
          return new Map.of({
                ...
                Constantes.CURRENT_PASSWORD   :  provedorBlocLoyalty.ultimoValorContrasenaActualChangePs ,
                Constantes.password           : provedorBlocLoyalty.ultimoValorNuevaContraChangePs
          });

     }

      bool verificarCompatibilidad( String nuevaContra, String confirmacionContrasena ){
          ...
          return SafeArea(
                ...
                children: <Widget>[
                     FlatButton(
                      ...
                      Icon(Icons.brightness_high, color: Colors.transparent,),
