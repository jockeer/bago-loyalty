    ...
    return Scaffold(
      ...
      floatingActionButton: 
          FloatingActionButton(
            ...
            elevation: 0.0,
            onPressed: () {
              Navigator.pushNamed(context, HomePage.nameOfPage);
            },
          ),
    ...
    return Center(
        ...
        child: ElevatedButton(
          ...
          child: Container(
              child: Row(
                children: [
                  Icon(Icons.exit_to_app_sharp, color:Colors.grey[600]),
                  Text("Salir", style: TextStyle(color: Colors.black),)
                ],
              ),
              // height: 10.0,
          ...
          return Theme(
            data: ThemeData.light().copyWith(
                ...
                colorScheme: ColorScheme.light(
                    primary: Colores.COLOR_ROJISO_TEXTO_LOYALTY),
                primaryColor:
