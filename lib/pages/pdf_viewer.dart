    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar( // Here we create one to set status bar color
            backgroundColor: Colores.COLOR_AZUL_ATC_FARMA, // Set any color of status bar you want; or it defaults to your theme's primary color
          )
        ),
        body: SafeArea(
                  child: Column(
                      children: <Widget>[
                          SizedBox( height: tamanoPhone.height * 0.01 , ),
  ...
  Widget _parteSuperior(BuildContext contextoParteSuperior){
      ...
      return Container(
        ...
        child: Row(
             ...
             children: <Widget>[
                 GestureDetector(
                       child: Icon(Icons.arrow_back_ios, color: Colores.COLOR_AZUL_ATC_FARMA,),
                      onTap: () {
  ...
  Widget _esPdf()  {
         ...
         try {
            return FutureBuilder(
                            ...
                            builder: ( BuildContext contexto , AsyncSnapshot<PDFDocument> asyncSnapshot ){
                                  ...
                                  if( asyncSnapshot.hasData ){
                                        return Theme(
                                                  ...
                                                  child: PDFViewer(
                                                      showPicker: false,
                                                      indicatorBackground: Colors.brown, 
