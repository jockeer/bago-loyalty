                ...
                children: <Widget>[
                     ...
                     Padding(
                       ...
                       Container(
                              ...
                              child:Image(image: AssetImage("assets/icons/logo-bago.png") , fit: BoxFit.cover,),
                       ),
                ],
 ...
 Widget btnEnviar( BuildContext contextoBtn ){
     ...
     return StreamBuilder(
           ...
           builder: ( BuildContext contexto, AsyncSnapshot<bool> asyncSnapshot){
                 return RaisedButton(
                              onPressed:   () {
                                      if(!asyncSnapshot.hasError && provedorDeBloc.ultimoValorName
                                       != null && provedorDeBloc.ultimoValorName != ""  && provedorDeBloc.ultimoValorLastName != null
                                       && provedorDeBloc.ultimoValorLastName != "" 
                                        && provedorDeBloc.ultimoValorCorreo != null  && provedorDeBloc.ultimoValorCorreo != ""
                                       && provedorDeBloc.ultimoValorPassword2 != null && provedorDeBloc.ultimoValorPassword2 != ""
                                       && provedorDeBloc.ultimoValorCodigoConsRegisterOne != null &&
                                       provedorDeBloc.ultimoValorCodigoConsRegisterOne != "" 
                                       ){
                                         verificadorInternet.verificarConexion()
                                            .then((valorRecibido){
                                                 if( valorRecibido[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                                      String accessToken = this.preferencias.devolverValor(Constantes.access_token, "null");
                                                      if( accessToken == "null" || accessToken == null ){
                                                          base.hitAccessTokenApi()
                                                            .then((valor) {
                                                                  //ok aqui mandarlo a la siguiente pagina pero ya con el accessToken
                                                                  //agregado
                                                                _llenarInformacion(contextoBtn);
                                                                String nuevoAccessToken =   this.preferencias.devolverValor(Constantes.access_token, "null");
                                                                provedorDeBloc.restablecerValorRegisterPartOne();
                                                                Navigator.of(contextoBtn).pushReplacementNamed(RegisterPartTwo.nameOfPage,
                                                     ...
                                                     base.showSnackBar("Por favor, revisar su conexion a internet",
                                                      contexto, 
  ...
  void _llenarInformacion(BuildContext contextoEnviar){
      ...
      this.informacionAEnviar = {
          Constantes.access_token : preferencias.devolverValor(Constantes.access_token, "null"),
          ...
          Constantes.CODIGO_CONSULTORIA : provedorDeBloc.ultimoValorCodigoConsRegisterOne
      };
         ...
         builder: ( BuildContext contexto, AsyncSnapshot asyncSnapshot ){
              return   TextField(
                              ...
                              decoration: InputDecoration(
                                 ...
                                 errorStyle: TextStyle( color: Colors.white),
                                  errorText: ( provedorDeBloc.ultimoValorPassword2 == "" ) ? null : asyncSnapshot.error
                              ),
                              onChanged: ( value ){
          ...
          builder: ( BuildContext contexto, AsyncSnapshot asyncSnapshot ){
                return   TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  errorStyle: TextStyle( color: Colors.white ),
                                  errorText: ( provedorDeBloc.ultimoValorCorreo == "" ) ? null : asyncSnapshot.error
                              ),
                              onChanged: ( value ){
