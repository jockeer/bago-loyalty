...
import 'package:bago/from_packages/swipped_button.dart';
...
import 'package:bago/providers/baseDeDatos/db_provider.dart';

import 'package:bago/providers/cards_providers.dart';
import 'package:bago/providers/obtaine_pin.dart';
import 'package:bago/providers/obtenerPuntosEveryTime.dart';
import 'package:bago/providers/oferts_provider.dart';
...
class _HomePageState extends State<HomePage>
  ...
  void _manejarElPin(dynamic data) {
    ...
    print(respuesta[Constantes.estado]);
  ...
  static void _isolateHandler(ThreadParams threadParams) async {
    ...
    Timer.periodic(Duration(seconds: 20), (t) {
      // periodo con el que se muestra el pin
                  ...
                  child: Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        FadeInImage(
                          fit: BoxFit.fill,
                          width: tamanoPhone.width * 0.29,
                          height: tamanoPhone.height * 0.12,
                          placeholder:
                        ...
                        Expanded(
                            child: Container(
                                ...
                                child: Text(
                                  ...
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: tamanoPhone.width * 0.025,
                                  ),
                                ))),
                      ],
                    ),
  ...
  Widget _cuerpor(BuildContext contexto) {
    final tamanoPhone = MediaQuery.of(contexto).size;
    final selectedColor = Colores.COLOR_AZUL_ATC_FARMA;
