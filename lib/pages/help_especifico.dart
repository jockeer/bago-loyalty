...
class ShowHelp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    this.mapaObtenidoDePreguntas = ModalRoute.of(context).settings.arguments as Map;  
  ...
  Widget _contenedorPreguntaRespuesta(BuildContext contexto){
        ...
        return Container(
              ...
              child: Container(
                    ...
                    child: Column(
                    children: <Widget>[
                          Text((  this.mapaObtenidoDePreguntas != null  && this.mapaObtenidoDePreguntas["question"] != null && this.mapaObtenidoDePreguntas["question"].length != 0   ) ? this.mapaObtenidoDePreguntas["question"] : "PREGUNTA", style: TextStyle( fontSize: 22.0, color: Colors.white  ) , textAlign: TextAlign.center,),
                          SizedBox( height: 10.0, ),
                          Padding(
                            padding: const EdgeInsets.only( left: 10.0 ),
                            child: Text( ( this.mapaObtenidoDePreguntas != null  && this.mapaObtenidoDePreguntas["answer"] != null && this.mapaObtenidoDePreguntas["answer"].length != 0 ) ? this.mapaObtenidoDePreguntas["answer"] : "RESPUESTA" , style: TextStyle( fontSize: 15.0, color: Colors.white ,  ) , textAlign: TextAlign.start,),
                          ),
                    ],  
                ),
              ),
