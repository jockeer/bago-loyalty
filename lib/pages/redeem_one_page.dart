                              ...
                              verificarConexion()
                                  .then((onValue){
                                        if( onValue[Constantes.estado] == Constantes.respuesta_estado_ok ){
                                            ...
                                            Navigator.of(contexto).pushNamed( //aqui estava popAndPushNamed
                                                RedeenTwoPage.nameOfPage,
                                              arguments: provedorDeBloc.ultimoValorSeleccionadoRadi
                                            );
    ...
    return StreamBuilder<Map<String, String>>(
      ...
      builder: (context, snapshot) {
        return Card(
              elevation: 10.0,
             child: RadioListTile(
                activeColor: Colores.COLOR_NARANJA_ATC_FARMA,
                title: Text(title),
                value: value, 
                                               ...
                                               List<Option> opcionesLista =  (respuesDesdeElprovider[Constantes.mensaje] as RedencionOne).data;  
                                                 return  ListView.builder(
                                                    ...
                                                    itemBuilder: ( BuildContext contexto , int indice )  {
                                                         return radioTile(contexto, indice,opcionesLista[indice].name,opcionesLista[indice].id);
                                                    }
                                              );
                                        }  else {
