import 'dart:async';
import 'package:bago/blocs/transformers.dart';
...
class BlocLoyalty with Validador{
     ...
     //Stream para direccion  en detalle de pedi
    final _streamControllerDireccionEditarDetalleCompr   = BehaviorSubject<String>();
    Stream<String>      get streamDireccionEditarDetalleCompr => _streamControllerDireccionEditarDetalleCompr.stream;
    Function(String)    get addDataToDireccionEditarDetalleComp => _streamControllerDireccionEditarDetalleCompr.sink.add;
    String              get ultimoValorDireccionEditarDetalleComp => _streamControllerDireccionEditarDetalleCompr.value;


    ///Stream para el subTotal 

    final _streamControllerSubTotalDetalle = BehaviorSubject<double>();
    Stream<double>      get streamSubTotalDetalle => _streamControllerSubTotalDetalle.stream;
    Function(double)    get addDataToSubTotalDetalle => _streamControllerSubTotalDetalle.sink.add;
    double              get ultimoValorDeSubTotalDetalle => _streamControllerSubTotalDetalle.value;

        /// 
      ///Nota del modo de pag
    ...
    Function(String)  get addDataToModoPagoNota => _streamControllerNotaModoPago.sink.add;
    ...
    Stream<bool>    get streamModoPagoLoading    => _streamControllerLoadingModoPago.stream;
    Function(bool)  get addDataToModoPagoLoading => _streamControllerLoadingModoPago.sink.add;
    bool            get ultimoValorModoPagoLoading => _streamControllerLoadingModoPago.value;
      ...
      final _streamControllerModoDePagoSelecc       = BehaviorSubject<String>();
        Stream<String>    get streamModoPagoSelec    => _streamControllerModoDePagoSelecc.stream;
        Function(String)  get addDataToModoPago => _streamControllerModoDePagoSelecc.sink.add;
      ...
      /// 
        ...
        Stream<bool>    get streamCantidadMAyorACero    => _streamControllerCantidadMayorACero.stream;
        Function(bool)  get addDataToCantidadMAyorACero => _streamControllerCantidadMayorACero.sink.add;
        bool            get ultimoValorCantidadMayorACero => _streamControllerCantidadMayorACero.value;
      ...
      Stream<int>       get streamUnidadesDialog     => _streamControllerUnidadesDialog.stream;
      Function(int)  get addDataToUnidadesDialog    => _streamControllerUnidadesDialog.sink.add; 
    ...
    Stream<String>    get streamActualizarPuntos    => _streamControllerPuntosAct.stream;
    Function(String)  get addDataToPuntosActualizar => _streamControllerPuntosAct.sink.add;
    ...
    Stream<bool>    get streamLoadingReedenTwo      => _streamControllerLoadingRedeenTwo.stream;
    Function(bool)  get addDataToLoadingReedenTwo   => _streamControllerLoadingRedeenTwo.sink.add;
    bool            get ultimoValorLoadingRedeenTwo => _streamControllerLoadingRedeenTwo.value;

    final _streamControllerTiendaRedeenTwo          = BehaviorSubject<String>();
    Stream<String>    get streamTiendaRedeenTwo     => _streamControllerTiendaRedeenTwo.stream.transform(validarTienda);
    Function(String)    get addDataToTiendaRedeenTwo  => _streamControllerTiendaRedeenTwo.sink.add;  
    String            get ultimoValorTiendaRedeenTwo  => _streamControllerTiendaRedeenTwo.value;

    final _streamControllerMontoRedeenTwo           = BehaviorSubject<String>();
    Stream<String>      get streamMontoRedeenTwo    =>  _streamControllerMontoRedeenTwo.stream.transform(validarMonto);
    Function(String)    get addDataToMontoRedeenTwo    =>  _streamControllerMontoRedeenTwo.sink.add;
    String              get ultimoValorMontRedeenTwo   =>  _streamControllerMontoRedeenTwo.value;

    Stream<bool> get validarCamposRedeenTwo => Observable.combineLatest2( streamTiendaRedeenTwo , streamMontoRedeenTwo, 
      (valor,valor1) {
            return true;
   });
    ...
    Stream<bool>    get streamLoadingChangePass       => _streamControllerLoadingChangePass.stream;
    Function(bool)  get addDataToLoadingChangePass    => _streamControllerLoadingChangePass.sink.add;
    bool            get ultimoValorDeLoadingChangePass => _streamControllerLoadingChangePass.value;

    final _streamControllerChangePassConrasenaActual    = BehaviorSubject<String>();
    Stream<String>    get streamCContrasenaActualChangeP => _streamControllerChangePassConrasenaActual.stream.transform(validarContrasenaActual);
    Function(String)  get addDataToContrasenaActualChangePas  => _streamControllerChangePassConrasenaActual.sink.add;
    String            get ultimoValorContrasenaActualChangePs => _streamControllerChangePassConrasenaActual.value;


    final _streamControllerChangePassNuevaContrasena    = BehaviorSubject<String>();
    Stream<String>    get streamCNuevaContraChangeP => _streamControllerChangePassNuevaContrasena.stream.transform(validarContrasenaActual);
    Function(String)  get addDataToNuevaContraChangePas  => _streamControllerChangePassNuevaContrasena.sink.add;
    String            get ultimoValorNuevaContraChangePs => _streamControllerChangePassNuevaContrasena.value;


    final _streamControllerChangePassConfirmPass    = BehaviorSubject<String>();
    Stream<String>    get streamConfirPassChangeP => _streamControllerChangePassConfirmPass.stream.transform(validarContrasenaActual);
    Function(String)  get addDataToConfirPassChangePas  => _streamControllerChangePassConfirmPass.sink.add;
    String            get ultimoValorConfirPassChangePs => _streamControllerChangePassConfirmPass.value;

     Stream<bool> get validarCamposChangePass => Observable.combineLatest3( streamCContrasenaActualChangeP,streamCNuevaContraChangeP,streamConfirPassChangeP,
    ...
    ///TODO ESTO ES STREAMINGS DE LA PANTALLA DE DETALLE DE CUENTA
     ...
     Function(bool) get addDataToStreamEditingOrNot   => _streamControllerEditingOrNot.sink.add;
     ...
     Stream<bool>       get streamCargandoDetalleCuenta   => _streamControllerCargandoDetalleCuenta.stream;
     Function(bool)   get addDataToCargandoDetalleCuenta  => _streamControllerCargandoDetalleCuenta.sink.add;
     bool           get ultimoValorCargandoDetalleCuenta => _streamControllerCargandoDetalleCuenta.value;



  final _streamControllerEmailDetalleCuenta = BehaviorSubject<String>();
  Stream<String>    get streamEmailDetalleCuenta       =>   _streamControllerEmailDetalleCuenta.stream.transform(validarEmail);
  Function(String)  get addDataToStreamEmailDetalleCuenta   =>   _streamControllerEmailDetalleCuenta.sink.add;
  String get ultimoValorEmailDetalleCuenta                =>    _streamControllerEmailDetalleCuenta.value; 

    final _streamControllerLastNameDetalleCuenta    = BehaviorSubject<String>();
    Stream<String>    get streamLastNamedDetalleCuenta       => _streamControllerLastNameDetalleCuenta.stream.transform(validarApellidoDetalleCuenta);
    Function(String)  get addDataToStreamLastNameDetalleCuen   => _streamControllerLastNameDetalleCuenta.sink.add;
    String            get ultimoValorLastNameDetalleCuenta  => _streamControllerLastNameDetalleCuenta.value;
   
    final _streamControllerNameDetalleCuenta          = BehaviorSubject<String>();
    Stream<String>     get streamNameDetalleCuenta          => _streamControllerNameDetalleCuenta.stream.transform(validarNombreDetalleCuenta);
    Function(String)   get addDataToStreamNameDetalleCuenta => _streamControllerNameDetalleCuenta.sink.add;
    String              get ultimoValorNameDetalleCuenta    => _streamControllerNameDetalleCuenta.value;
   

    final _streamControllerGeneroDetalleCuenta         = BehaviorSubject<String>();
    Stream<String>  get streamGeneroDetalleCuenta   =>  _streamControllerGeneroDetalleCuenta.stream;
    Function(String) get addDataToStreamGeneroDetalleCue   => _streamControllerGeneroDetalleCuenta.sink.add;
    String           get ultimoValorGeneroDetalleCuen      => _streamControllerGeneroDetalleCuenta.value;

    final _streamControllerFechaNacDetalleCuenta        = BehaviorSubject<String>();
    Stream<String>    get streamFechaNacDetalleCuenta   => _streamControllerFechaNacDetalleCuenta.stream.transform(validarFechaNac);
    Function(String)  get addDataToStreamFechaNacDetalleCuenta => _streamControllerFechaNacDetalleCuenta.sink.add;
    String            get ultimoValorFechaNacDetalleCu    => _streamControllerFechaNacDetalleCuenta.value;

     Stream<bool> get validarCamposDetalleCuenta => Observable.combineLatest4( streamNameDetalleCuenta , streamLastNamedDetalleCuenta, streamEmailDetalleCuenta,streamFechaNacDetalleCuenta,
  ...
  //TODO ESTO ES PARA LA PANTALLA DE VER PIN DE VALIDACION
    ...
    Stream<bool>        get streamLoadingPinScreen      => _streamControllerLoadingPinScreen.stream;  
    Stream<String>      get streamPinValidator          => _streamControllerValidarPin.stream.transform(validarPin);
    Function(bool)      get addDataToLoadinPinScreen    => _streamControllerLoadingPinScreen.sink.add;
    Function(String)    get addDataToStreamPinValidator => _streamControllerValidarPin.sink.add;
    bool                get ultimoValorLoadingPinScreen => _streamControllerLoadingPinScreen.value;
  ...
  Stream<String>    get streamEmailRecoverPassword        =>   _streamControllerEmailRecoverPassword.stream.transform(validarEmail);
  Function(String)  get addDataToStreamEmailRecoverPass   =>   _streamControllerEmailRecoverPassword.sink.add;
  String get ultimoValorEmailRecoverPass                  =>    _streamControllerEmailRecoverPassword.value; 
  ...
  final _streamControllerTandC            = BehaviorSubject<bool>(); 
    ...
    Stream<String>      get streamCiudadExpedicion  => _streamControllerCiudadExpedicion.stream;
    Stream<String>      get streamFechaNacimiento   => _streamControllerFechaNacimiento.stream;
    ...
    Function(String)  get addDataToStreamCiudadExp      => _streamControllerCiudadExpedicion.sink.add;
    Function(String)  get addDataToStreamFechaNac       => _streamControllerFechaNacimiento.sink.add;
    Function(String)  get addDataToStreamPais           => _streamControllerPais.sink.add;
    Function(String)  get addDataToStreamCiudad         => _streamControllerCiudad.sink.add;
   ...
   bool            get    ultimoValorTermsAndCond     => _streamControllerTandC.value; 
    ...
    Observable.combineLatest8(streamCi_Nit, streamCiudadExpedicion, streamFechaNacimiento, streamPais,streamCiudad,streamTipoCliente,streamCelular,streamTandCondition,
     (valor2, valor3, valor4, valor5,valor6,valor7,valor8,valor9)
   {
            print(valor2);
            print(valor3);
            print(valor4);
...
//esto es para el login
   Stream<String> get contrasenaStream  => _streamControllerPassword.stream.transform( validarContrasena );
   Stream<String> get ciStream          => _streamControllerCI.stream.transform( validarCI  );


//este stream es para ver el cargador
   Stream<bool>   get refreshingStream  => _streamControllerRefreshing.stream.transform( validarStreamRefreshing );
   ...
   Stream<Map<String, String>> get radioStream       => _streamControllerRadioRedeen.stream;
  ...
  //esto es de la primera pantalla de registro
   Stream<String> get nameStream => _streamControllerName.stream.transform( validarName);
   Stream<String> get lastnamelStream => _streamControllerLastName.stream.transform( validarLastName);
   Stream<String> get emailStream => _streamControllerEmail.transform( validarEmail);
   Stream<String> get password2Stream => _streamControllerPassword2.stream.transform( validarContrasena);
   
   final _streamControllerCodigoConsultRegisterOne = BehaviorSubject<String>();
   Stream<String> get codigoConsultStreamRegisterone => _streamControllerCodigoConsultRegisterOne.stream.transform(validarCodigoConsultoria);
   Function(String)  get addDataToCondigoConsRegisterOne => _streamControllerCodigoConsultRegisterOne.sink.add;
   String            get ultimoValorCodigoConsRegisterOne => _streamControllerCodigoConsultRegisterOne.value;




  //validador de login
   Stream<bool> get validarCampos => Observable.combineLatest2(contrasenaStream, ciStream, (valor,valor1) {
            print("==================");
            print(valor);
            print("==================");
            return true;
  ...
  //validador de registro pantalla 1
   Stream<bool> get validarUsuario => Observable.combineLatest4(nameStream, lastnamelStream, emailStream, password2Stream, (valor2, valor3, valor4, valor5)
   {
            print("==================");
            print(valor2);
            print("==================");
    ...
    Function(String) get addDataToStreamPassword    => _streamControllerPassword.sink.add;
    Function(String) get addDataToStreamCI          => _streamControllerCI.sink.add;
    Function(bool)   get addDataToStreamRefresing   => _streamControllerRefreshing.sink.add; 
    Function(String) get addDataToStreamMensaje     => _streamControllerMensaje.sink.add;
    Function(bool)   get addDataToStreamCargando    => _streamControllerRefreshing.sink.add;
    Function(Map<String, String>) get addDataToStreamRadioRedeen => _streamControllerRadioRedeen.sink.add; 
    Function(String) get addDataToStreamName => _streamControllerName.sink.add;
    Function(String) get addDataToStreamLastName => _streamControllerLastName.sink.add;
    Function(String) get addDataToStreamEmail => _streamControllerEmail.sink.add;
    Function(String) get addDataToStreamPassword2 => _streamControllerPassword2.sink.add;
    ...
    Map<String, String>    get     ultimoValorSeleccionadoRadi              => _streamControllerRadioRedeen.value;
